...
export default function TournamentHeader({tournamentDetails, preloading}) {
  return (
    ...
    <div className="flex flex-col h-60 w-full overflow-hidden relative border-8 rounded-md" style={{borderColor:"#373434"}}>
        ...
        {!preloading ? (
          ...
          <div class="flex animate-pulse">  
            <div class="flex-1 space-y-6 py-1">   
              <div class="h-[300px] mt-[-10px] rounded bg-gray-400"></div>
            </div>
          </div>
        )}
      ...
      <div className="w-100 bg-container-tournament border-white text-pink-900 px-10 py-3 pb-5 text-2xl mt-[-135px] z-20 rounded-md justify-center flex flex-col">
        {!preloading ? (
          ...
          <div className="flex justify-center w-[200px] h-24">
            <div className="animate-spin h-8 w-8 mt-10 border-4 border-pink-custom border-t-transparent rounded-full"></div>
          </div>
        )}
      </div>
